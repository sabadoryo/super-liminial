...
class App extends Component {
    ...
    handleButtonState(props) {
        ...
        if (props == 2) {
            this.setState({
                mainDef: 'Вы увидели симпатичную девушку в торговом центре и хотите с ней познакомиться.'
            })
        }
        if (props == 3) {
            this.setState({
                mainDef: 'Вы пришли на собесдование, вам нужно выстроить диалог таким образом чтобы работодатель захотел взять вас на должность.'
            })
        }
